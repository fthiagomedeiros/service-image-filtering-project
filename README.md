...
Follow the process described in the course to `eb init` a new application and `eb create` a new environment to deploy your service! Don't forget you can use `eb deploy` to push changes.
